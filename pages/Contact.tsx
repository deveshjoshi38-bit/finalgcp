...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const subject = `Enquiry: ${formData.projectType} from ${formData.name}`;
    const body = `Hello Girl Child Productions Team,\n\nYou have received a new inquiry from your website contact form:\n\n` +
      `--------------------------------------\n` +
      `CONTACT DETAILS\n` +
      `--------------------------------------\n` +
      `Name: ${formData.name}\n` +
          ...
          >
            <div className="mb-16">
              ...
              <motion.h2
                ...
                className="text-5xl md:text-7xl font-serif font-medium leading-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-gray-100 via-gray-400 to-gray-200"
              >
                Get In Touch
              </motion.h2>
              <motion.div
                ...
                className="h-1 w-24 md:w-32 bg-white"
              />
            </div>
            ...
            <div className="border-t border-neutral-800 pt-8">
              ...
              <div className="flex space-x-4">
                <a href={CONTACT_INFO.socials.instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center bg-neutral-900 text-gray-400 hover:bg-[#E4405F] hover:text-white transition-all rounded-full border border-neutral-800">
                  <Instagram size={18} />
                </a>
                <a href={CONTACT_INFO.socials.linkedin} target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center bg-neutral-900 text-gray-400 hover:bg-[#0077B5] hover:text-white transition-all rounded-full border border-neutral-800">
                  <Linkedin size={18} />
                </a>
                <a href={CONTACT_INFO.socials.whatsapp} target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center bg-neutral-900 text-gray-400 hover:bg-[#25D366] hover:text-white transition-all rounded-full border border-neutral-800">
