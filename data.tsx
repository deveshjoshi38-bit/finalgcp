...
export const WORK_ITEMS: WorkItem[] = [
  ...
  {
    id: '24',
    title: "Holi: Hope for India's Widows",
    category: 'Documentary',
    image: 'https://img.youtube.com/vi/8b65QoLVMBU/maxresdefault.jpg',
    year: '2023',
    videoUrl: 'https://youtu.be/8b65QoLVMBU',
  },
  {
    id: '25',
    title: 'Niva Bupa Smart Health+',
    category: 'TVC',
    image: 'https://img.youtube.com/vi/upsfOfD2Izo/maxresdefault.jpg',
    year: '2023',
    videoUrl: 'https://youtu.be/upsfOfD2Izo',
  },
  {
    id: '26',
    title: "The Big Forkers’ South Delhi Eats",
    category: 'Web Series',
    image: 'https://img.youtube.com/vi/Yj-AVuQXYGQ/maxresdefault.jpg',
    year: '2023',
    videoUrl: 'https://youtu.be/Yj-AVuQXYGQ',
  },
  {
    id: '27',
    title: "The Big Forkers at Masque",
    category: 'Web Series',
    image: 'https://img.youtube.com/vi/4FFm2s-_jSk/maxresdefault.jpg',
    year: '2023',
    videoUrl: 'https://youtu.be/4FFm2s-_jSk',
  },
  {
    id: '28',
    title: "The Big Forkers at Indian Accent",
    category: 'Web Series',
    image: 'https://img.youtube.com/vi/xXOvskCPCbc/maxresdefault.jpg',
    year: '2023',
    videoUrl: 'https://youtu.be/xXOvskCPCbc',
  },
  {
    id: '29',
    title: "The Big Forkers at Gung The Palace",
    category: 'Web Series',
    image: 'https://img.youtube.com/vi/27t8sDDiMqk/maxresdefault.jpg',
    year: '2023',
    videoUrl: 'https://youtu.be/27t8sDDiMqk',
  },
  {
    id: '30',
    title: "The Boy Who Sees The World Upside Down",
    category: 'Documentary',
    image: 'https://img.youtube.com/vi/Sj4IgAohsKs/maxresdefault.jpg',
    year: '2016',
    videoUrl: 'https://youtu.be/Sj4IgAohsKs',
  },
...
export const CLIENT_LOGOS = [
  'The Big Forkers', 'District', 'The Telegraph', 'Captain Sales',
  'Glida', 'Fortum', 'PFC Foods', 'Embee Software', 'Fabiosa Media',
  'TLC', 'ITV', 'Discovery', 'BBC', 'NBC',
  'Channel 5', 'NDTV', 'NIIT', 'Hero Cycles', 'Niva Bupa',
  'Sarvodaya Hospital', 'Salim–Sulaiman', 'JK Paper', 'Daily Mail',
  'Marie Claire', 'Rekhta', 'Screentripping Films', 'Merchant Records',
  'Cover Asia Press', 'Arte', 'Metro', 'Mirror', 'Grazia',
  'Glue Creatives', 'Harfun', 'Solugo', 'Suburb Magazine', 'Tycoon Global'
];
